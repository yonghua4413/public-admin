...
<div id="container">
    <form class="form-horizontal" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" name="class_name" value="{{$info->class_name}}" placeholder="分类名称" class="form-control">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <div class="i-checks"><label> <input type="radio" @if($info->is_show == 1) checked @endif value="1" name="is_show"> <i></i> 显示 </label></div>
                <div class="i-checks"><label> <input type="radio" @if($info->is_show == 0) checked @endif value="0" name="is_show"> <i></i> 隐藏 </label></div>
            </div>
        </div>
        <div class="form-group">
